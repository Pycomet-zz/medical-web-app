...
SECRET_KEY = 'r$d6zjpj@_b#1c-pm@r2g!pfup*!zns3je7zv_op5wnn*f@a%r' # This is where you include your SECRET_KEY
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = '' # Email Host address for mailing
EMAIL_HOST_PASSWORD = '' # Email Host Password for mailing
